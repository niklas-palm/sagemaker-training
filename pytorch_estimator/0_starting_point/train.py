...
if __name__ == "__main__":
    ...
    # This is used to access the parameters above using a similar syntax as if we received these variables as arguments.
    # It will make sense in the following sections.
